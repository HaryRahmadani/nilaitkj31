...
<head>
    ...
    <title>Aplikasi Nilai by Hary Rahmadani</title>
    <link rel="shortcut icon" href="gambar/logo1.png" type="image/x-icon">
    ...
    <div class="card">
        <div class="card-body bg-info">
             ...
             <span class="float-end">
                Versi 1.0 by <a href="http://hary.rf.gd/?m=home" target="blank" rel="noopener noreferrer">Hary Rahmadani</a>
             </span>
        </div>
    </div>
</div>
